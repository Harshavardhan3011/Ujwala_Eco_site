  ...
  return (
    <div className="bg-white p-8 rounded-3xl border border-eco-100 shadow-xl space-y-6">
      <div className="text-center space-y-2">
        ...
        <h1 className="font-serif font-bold text-2xl text-slate-900">Sign In to Ujwala</h1>
        <p className="text-xs text-slate-500">Access your saved orders, cart, and wishlist</p>
      </div>
      ...
      {/* Demo Quick Fill Box */}
      <div className="p-3 bg-canvas-100 rounded-2xl border border-eco-100 text-xs space-y-1 text-slate-600">
        <p className="font-bold text-slate-800">Quick Test Demo Credentials:</p>
        <div className="flex gap-2 pt-1">
          <button
            type="button"
            onClick={() => {
              setEmail('admin@ujwalaeco.com');
              setPassword('admin123');
            }}
            className="bg-eco-100 text-eco-900 px-2.5 py-1 rounded-lg text-[10px] font-bold"
          >
          ...
          <button
            ...
            className="bg-jute-100 text-jute-900 px-2.5 py-1 rounded-lg text-[10px] font-bold"
          >
