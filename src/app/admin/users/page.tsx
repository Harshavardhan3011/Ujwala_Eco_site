...
import { UserCheck, UserPlus, Trash2, ShieldAlert, AlertCircle, CheckCircle2 } from 'lucide-react';
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white p-6 rounded-2xl border border-eco-100 shadow-xs">
        <div>
          <div className="flex items-center gap-2">
            <UserCheck className="w-5 h-5 text-eco-700" />
            <h2 className="font-serif font-bold text-xl text-slate-900">Admin User Management</h2>
          </div>
          <p className="text-xs text-slate-500 mt-1">Superadmin portal to create and manage operational administrative staff</p>
        </div>
        <button
          onClick={() => {
            setFormError('');
          ...
          className="bg-eco-800 hover:bg-eco-900 text-white font-bold text-xs px-4 py-2.5 rounded-xl shadow-xs transition-colors flex items-center gap-2"
        >
            ...
            <form onSubmit={handleCreateAdmin} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-canvas-100 border border-eco-200 rounded-xl py-2.5 px-3 text-xs focus:outline-none focus:ring-1 focus:ring-eco-600"
                />
              </div>
              ...
              <div className="pt-2 flex justify-end gap-3 border-t border-eco-100">
                ...
                <button
                  ...
                  className="bg-eco-800 hover:bg-eco-900 text-white font-bold text-xs px-4 py-2 rounded-xl shadow-xs"
                >
